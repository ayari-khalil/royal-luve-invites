...
import { MapPin, Calendar, MessageCircle, Sparkles as SparkleIcon, Music, Volume2, VolumeX } from "lucide-react";
...
function CurtainStage({
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-[#080002]">
...
export function RideauImperialTemplate({ inv }: { inv: Invitation }) {
  ...
  return (
    <div dir="rtl" className="relative min-h-screen bg-velours-dark text-[#fbeed7] overflow-x-hidden">
      <style>{`
        .bg-velours-dark {
          background:
            radial-gradient(circle at 50% 30%, #2f040d 0%, #120104 65%, #050001 100%);
        }
        .glass-velvet {
